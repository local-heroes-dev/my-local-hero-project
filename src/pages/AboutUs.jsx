...
const AboutUs = () => {
  const developers = [
        ...
        linkedin: "https://www.linkedin.com/in/abdillahi-mohamoud-mohamed-895719253/",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're a passionate team of developers dedicated to building platforms that celebrate 
            community heroes and bring people together. Our mission is to recognize the everyday 
            people making extraordinary differences in their communities.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Celebrate Heroes</h3>
              <p className="text-gray-600">Recognize and celebrate the everyday people making extraordinary differences in their communities.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Connect people through shared stories of inspiration and create stronger, more supportive communities.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Inspire Action</h3>
              <p className="text-gray-600">Motivate others to make positive changes in their own communities through the power of example.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {developers.map((developer) => (
              <div key={developer.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                {/* Profile Image */}
                ...
                <div className="p-6">
                  ...
                  <p className="text-orange-600 font-medium mb-3">{developer.role}</p>
